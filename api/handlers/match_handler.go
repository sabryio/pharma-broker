...
// GetMatchesGin returns pending matches with pagination (Gin)
...
// ConfirmMatchGin confirms a pending match (Gin)
...
// RejectMatchGin rejects a pending match (Gin)
...
// ExportMatchesCSVGin exports matched pairs to CSV format (Gin)
