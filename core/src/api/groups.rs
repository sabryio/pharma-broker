...
pub async fn get_groups<O, R, M, G>(
...
pub async fn get_group<O, R, M, G>(
    State(state): State<AppState<O, R, M, G>>,
...
pub async fn create_group<O, R, M, G>(
    State(state): State<AppState<O, R, M, G>>,
...
pub async fn update_group<O, R, M, G>(
    State(state): State<AppState<O, R, M, G>>,
    Path(jid): Path<String>,
...
pub async fn delete_group<O, R, M, G>(
    State(state): State<AppState<O, R, M, G>>,
    Path(jid): Path<String>,
